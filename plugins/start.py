    ...
    if FORCE_SUB:
        try:
          ...
          if str(user.status) == "ChatMemberStatus.BANNED":
              await message.reply_text("You are Banned. Contact -- Ezhil")
              return 1
            ...
            return 1
        except Exception as ezhil:
            await message.reply_text(f"Something Went Wrong. Contact admins... with following message {ezhil}")
            return 1 
...
async def plan(client, message):
    plan_text = (
        "> 💰 **Premium Price**:\n\n Starting from $2.5 or 250 INR accepted via **__Amazon Gift Card__** (terms and conditions apply).\n"
